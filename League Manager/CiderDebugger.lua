...
local CiderRunMode = {};CiderRunMode.runmode = 'RUN';CiderRunMode.assertImage = true;CiderRunMode.userdir = "R:/Users/Nathan/AppData/Roaming/luaglider2/dev";local SOCKET_PORT=57489;local GLIDER_MAIN_FOLDER= "R:/Users/Nathan/Documents/My Projects/League Manager";local useNativePrint= false;local snapshotInterval= -1;local snapshotInterval= -1;local fileFilters= {"CiderDebugger.lua",};local startupMode= "require";local function shouldDebug()
